...
module.exports = {
    ...
    var eventEmitter = function( tableId ) {
        ...
        var mesas = [
            {id: 0,name : 'Sample 10-handed Table',seats : 10,bb: 2,sb: 1,maxBuyIn: 200,minBuyIn: 40,privateTable: false},
            {id: 1,name : 'Sample 6-handed Table',seats : 6,bb: 2,sb: 1,maxBuyIn: 200,minBuyIn: 40,privateTable: false},
            {id: 2,name : 'Sample 2-handed Table',seats : 2,bb: 2,sb: 1,maxBuyIn: 200,minBuyIn: 40,privateTable: false}, 
        ]
         mesas.forEach(
             function(mesa){
                 tables[mesa.id] = new Table( mesa.id, mesa.name, eventEmitter(mesa.id), mesa.seats, mesa.bb, mesa.sb, mesa.maxBuyIn, mesa.minBuyIn,mesa.privateTable);
             }
         );
